        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data">
                    ...
                    <!-- Cover -->
                    <div class="mt-4">
                        <img src="{{ Storage::url($product->cover) }}" class="h-32 w-52 mb-2 rounded-md object-cover"
                            alt="product">
                    ...
                    <!-- Path File -->
                    <div class="mt-4">
                        <p class="text-sm mb-2">Current path file: <span
                                class="italic underline">{{ $product->path_file }}</span></p>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about"
                            class="border-gray-300 focus:border-indigo-500 mt-1 w-full focus:ring-indigo-500 rounded-md shadow-sm">{{ $product->about }}</textarea>
