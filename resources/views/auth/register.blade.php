@extends('front.layouts.app-custom')
@section('title', 'Register | Belibang')
@section('content')
    <x-navbar :categories="$categories" />
    <div class="h-20"></div>
    <div class="min-h-screen flex flex-col sm:justify-center items-center py-10 sm:pt-0">
        <div
            class="w-full sm:max-w-md mt-6 border-b-4 border-slate-500 px-6 py-4 shadow-md overflow-hidden sm:rounded-lg text-black bg-white">
            <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="mt-4">
                    ...
                    <div class="relative border rounded-xl p-2 bg-slate-200 cursor-pointer">
                        <p class="text-black text-center text-sm">Tambahkan Foto</p>
                        <x-text-input id="avatar"
                            class="absolute opacity-0 z-50 cursor-pointer top-0 right-0 left-0 bottom-0" type="file"
